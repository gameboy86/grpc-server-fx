...
type PrometheusServerMetrics interface {
	UnaryServerInterceptor(opts ...grpcprom.Option) grpc.UnaryServerInterceptor
...
func NewGRPCPromServerMetrics() *grpcprom.ServerMetrics {
